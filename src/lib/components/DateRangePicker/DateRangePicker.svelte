...
<script lang="ts">
    ...
    let {
        ...
        monthControls = true,
        yearControls = true,
        prevMonthIcon = 'icon-[lucide--chevron-left]',
        nextMonthIcon = 'icon-[lucide--chevron-right]',
        prevYearIcon = 'icon-[lucide--chevrons-left]',
        nextYearIcon = 'icon-[lucide--chevrons-right]',
        icon = 'icon-[lucide--calendar]',
        separatorIcon = 'icon-[lucide--minus]',
        side = 'bottom',
        sideOffset = 8,
        align = 'start',
        alignOffset = 0,
